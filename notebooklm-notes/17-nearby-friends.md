...
Continuously ingest friend locations, map them to geographic channels, and push relevant updates to connected friends. Geohash partitioning and Redis Pub/Sub scale fan-out while treating highly connected users specially.
...
### 1. channel distribution data

This data-model or worked-example diagram. It uses rows, columns, record fields, or sample values to show exactly what is stored or how a result is calculated in **Scaling deep-dive on redis pub/sub component**. It explains **channel distribution data** as part of the nearby friends design, so read the connections, ordering, partitions, or fields as the concrete representation of the surrounding discussion.

### 2. consistent hashing

This spatial or partitioning illustration. It divides a map, hash ring, or key space into cells or ranges and highlights how a lookup crosses boundaries or selects an owner in **Scaling deep-dive on redis pub/sub component**. It explains **consistent hashing** as part of the nearby friends design, so read the connections, ordering, partitions, or fields as the concrete representation of the surrounding discussion.

### 3. detailed periodic location update

This labeled conceptual diagram. It uses simple boxes, arrows, or a focused before-and-after view to isolate the mechanism rather than the whole system in **Periodic location update**. It explains **detailed periodic location update** as part of the nearby friends design, so read the connections, ordering, partitions, or fields as the concrete representation of the surrounding discussion.

### 4. fan out backend

This labeled conceptual diagram. It uses simple boxes, arrows, or a focused before-and-after view to isolate the mechanism rather than the whole system in **High-level design**. It explains **fan out backend** as part of the nearby friends design, so read the connections, ordering, partitions, or fields as the concrete representation of the surrounding discussion.

### 5. geohash borders

This spatial or partitioning illustration. It divides a map, hash ring, or key space into cells or ranges and highlights how a lookup crosses boundaries or selects an owner in **Nearby random person**. It explains **geohash borders** as part of the nearby friends design, so read the connections, ordering, partitions, or fields as the concrete representation of the surrounding discussion.

### 6. geohash pubsub

This spatial or partitioning illustration. It divides a map, hash ring, or key space into cells or ranges and highlights how a lookup crosses boundaries or selects an owner in **Nearby random person**. It explains **geohash pubsub** as part of the nearby friends design, so read the connections, ordering, partitions, or fields as the concrete representation of the surrounding discussion.

### 7. location updates geohash

This spatial or partitioning illustration. It divides a map, hash ring, or key space into cells or ranges and highlights how a lookup crosses boundaries or selects an owner in **Nearby random person**. It explains **location updates geohash** as part of the nearby friends design, so read the connections, ordering, partitions, or fields as the concrete representation of the surrounding discussion.

### 8. periodic location update

This labeled conceptual diagram. It uses simple boxes, arrows, or a focused before-and-after view to isolate the mechanism rather than the whole system in **Periodic location update**. It explains **periodic location update** as part of the nearby friends design, so read the connections, ordering, partitions, or fields as the concrete representation of the surrounding discussion.

### 9. redis pubsub usage

This labeled conceptual diagram. It uses simple boxes, arrows, or a focused before-and-after view to isolate the mechanism rather than the whole system in **High-level design**. It explains **redis pubsub usage** as part of the nearby friends design, so read the connections, ordering, partitions, or fields as the concrete representation of the surrounding discussion.

### 10. simple high level design

This component architecture diagram. It arranges client-facing entry points, service boxes, queues or caches, and durable stores as separate layers; arrows identify the request or event paths between them in **High-level design**. It explains **simple high level design** as part of the nearby friends design, so read the connections, ordering, partitions, or fields as the concrete representation of the surrounding discussion.

## Source lesson text

_Source: `17. Nearby Friends/README.md`. Embedded figures are replaced by the visual guide above; all written lesson content is retained below._
